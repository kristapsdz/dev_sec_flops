...
githubAttestations: 
    ...
    kristapsdz kristapsdz/slant,
    kristapsdz kristapsdz/sqlbox,
    kristapsdz kristapsdz/sqlite2mdoc,
    rnagy chromium/chromium,
    kaniini pkgconf/pkgconf,
    mptre mptre/yank,
    Larhzu tukaani-project/xz,
    stoeckmann stoeckmann/xwallpaper,
    frnzhop phillbush/xnotify,
    fcambus ansilove/ansilove,
    omar-polo omar-polo/amused,
    letoram letoram/arcan,
    ThomasHabets ThomasHabets/arping,
    gavinhoward gavinhoward/bc,
    fcambus fcambus/bdf2sfd,
    sthen bgp/bgpq4,
    pdewacht pdewacht/brlaser,
    semarie semarie/checkrestart,
    kivikakk commonmark/cmark,
    shawnw agordon/datamash,
    jedisct1 jedisct1/dsvpn,
    klemensn Digital-chaos/dwm,
    hiltjo Digital-chaos/dmenu,
    arun skeeto/endlessh,
    eradman eradman/entr,
    landryb mozilla-firefox/firefox,
    ltratt ltratt/extsmail,
    mcjsk mcjsk/fnc,
    drhsqlite drhsqlite/fossil-mirror,
    PeterHajdu PeterHajdu/fwa,
    omar-polo omar-polo/gmid,
    mbelop mbelop/icbd,
    lcheylus lcheylus/icbirc-portable,
    vext01 gophernicus/gophernicus,
    stapelberg i3/i3,
    jpmens jpmens/jo,
    thexhr thexhr/jrnlc,
    mptre mptre/knfmt,
    ...
    bigio memcached/memcached,
    zehome zehome/MLVPN,
    cgull mobile-shell/mosh,
    sjmulder sjmulder/nostt,
    epsilon-0 PurritoBin/PurritoBin,
    semarie radareorg/radare2,
    jcs jcs/sdorfehs,
    hiltjo dxwc/sfeed,
    worr conformal/spectrwm,
    hiltjo oxalorg/stagit,
    bluhm OISF/suricata,
    ...
    jcs jcs/tpadnav,
    younix younix/ucspi,
    basepr1me basepr1me/thingsd,
    omar-polo telescope-browser/telescope,
    uhlin uhlin/swirc,
    Partmedia SSHGuard/sshguard,
    eradman eradman/rset,
    mptre mptre/robsd,
    epsilon-0 PurritoBin/PurritoBin,
    mptre mptre/pick,
    kristapsdz haesbaert/mdnsd,
    grayed grayed/oicb,
    jeremyevans jeremyevans/mp3applygain,
    zehome zehome/MLVPN,
    miniupnp miniupnp/miniupnp,
    mptre mptre/mdsort,
    levaidaniel levaidaniel/kc,
    stspdotname ThomasAdam/got-portable,
    NanXiao NanXiao/free,
    reyk reyk/cloud-agent,
    guijan guijan/dictpw,
    eafer eafer/rdrview,
    adamsteen Solo5/solo5,
openbsdAttestations:
    deraadt src/usr.bin/apply,
    ratchov src/usr.bin/aucat,
    ...
    kristapsdz src/usr.sbin/acme-client,
    ...
    kristapsdz src/usr.sbin/rpki-client,
