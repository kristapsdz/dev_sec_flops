...
githubAttestations: 
    ...
    zoulasc file/file,
    jld mozilla-firefox/firefox,
    netblue30 netblue30/firejail,
    ...
    aszlig NixOS/nix,
    eric-s-raymond ntpsec/ntpsec,
    nmap openconnect/ocserv,
    zachmann indigo-dc/oidc-agent,
    vapier gentoo/pax-utils,
    cedric-vincent proot-me/proot,
    otubo qemu/qemu,
    nimrodpar rr-debugger/rr,
    Smattr Smattr/rumur,
    mvo5 canonical/snapd,
    gconnell google/stenographer,
    ldv-alt strace/strace,
    ColinIanKing ColinIanKing/stress-ng,
